...
(function (w, d) {
  ...
  var TH2EN = {
    ...
    'เปิดดูออนไลน์': 'View online',
    'เล่ม 1 · สินค้าใหม่ 2026': 'Volume 1 · New for 2026',
    'เล่ม 2 · ฉบับเต็ม': 'Volume 2 · Full edition',
    'รวมสินค้าใหม่และรายการอัปเดตล่าสุดประจำปี 2026': 'New products and the latest line-up updates for 2026.',
    'แคตตาล็อกสินค้าฉบับเต็มทุกแบรนด์ในเครือ VFOODS': 'The full product catalog for every VFOODS brand.',
    'สินค้าใหม่ · รายการอัปเดตล่าสุด': 'New products · Latest updates',
    'สินค้าทุกแบรนด์ในเครือ VFOODS': 'Every VFOODS brand',
    'PDF · 43.6 MB · 15 หน้า': 'PDF · 43.6 MB · 15 pages',
    'PDF · 36.4 MB · 6 หน้า': 'PDF · 36.4 MB · 6 pages',
    'เปิดดูสินค้าทั้งหมดของ VFoods ฉบับล่าสุด — ขนมปังปี๊บ บิสกิต เวเฟอร์ คุกกี้สอดไส้ และอีกมากมาย ดาวน์โหลดไฟล์ PDF ทั้ง 2 เล่มได้ด้านล่าง':
      'Browse VFoods’ full product range in the latest edition — tin-packed biscuits, wafers, cream-filled cookies and more. Both volumes are available as PDFs below.',
